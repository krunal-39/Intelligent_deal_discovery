...
#     joblib.dump(svd, OUTPUT_DIR / "svd_transform.pkl")

#     print("Saved model, vectorizer, SVD.")
# #!/usr/bin/env python3
...
# OUTPUT_DIR = PROJECT_ROOT / "src" / "models" / "lightgbm_price_model_full"
...
#     print("Running SVD (reduce 120k → 1500 dims)...")
